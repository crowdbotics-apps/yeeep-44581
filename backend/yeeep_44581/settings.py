"""
Django settings for yeeep_44581 project.
...
WSGI_APPLICATION = 'yeeep_44581.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "yeeep_44581 API",
    "DESCRIPTION": "API documentation for yeeep_44581 App",
    "VERSION": "v1",
}
